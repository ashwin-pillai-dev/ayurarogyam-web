...
/* harmony export */ });
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(41327);
/* harmony import */ var _apollo_usage_reporting_protobuf__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(46244);
/* harmony import */ var _utils_UnreachableCaseError_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(52881);
...
class TraceTreeBuilder {
    constructor(options){
        this.rootNode = new _apollo_usage_reporting_protobuf__WEBPACK_IMPORTED_MODULE_0__/* .Trace */ .fM.Node();
        ...
        if (!sendErrors || "masked" in sendErrors) {
            this.transformError = ()=>new graphql__WEBPACK_IMPORTED_MODULE_1__.GraphQLError("<masked>", {
                    extensions: {
                        maskedBy
                    }
                });
            ...
            throw new _utils_UnreachableCaseError_js__WEBPACK_IMPORTED_MODULE_2__/* .UnreachableCaseError */ .S(sendErrors);
        }
    }
    startTiming() {
        if (this.startHrTime) {
    ...
    newNode(path) {
        const node = new _apollo_usage_reporting_protobuf__WEBPACK_IMPORTED_MODULE_0__/* .Trace */ .fM.Node();
        const id = path.key;
        if (typeof id === "number") {
            node.index = id;
        } else {
    ...
    transformAndNormalizeError(err) {
        if (this.transformError) {
            ...
            if (!(rewrittenError instanceof graphql__WEBPACK_IMPORTED_MODULE_1__.GraphQLError)) {
                return err;
            }
            return new graphql__WEBPACK_IMPORTED_MODULE_1__.GraphQLError(rewrittenError.message, {
                nodes: err.nodes,
                source: err.source,
...
function errorToProtobufError(error) {
    return new _apollo_usage_reporting_protobuf__WEBPACK_IMPORTED_MODULE_0__/* .Trace */ .fM.Error({
        message: error.message,
        location: (error.locations || []).map(({ line, column })=>new _apollo_usage_reporting_protobuf__WEBPACK_IMPORTED_MODULE_0__/* .Trace */ .fM.Location({
                line,
                column
            })),
...
function dateToProtoTimestamp(date) {
    ...
    return new _apollo_usage_reporting_protobuf__WEBPACK_IMPORTED_MODULE_0__/* .google */ .lk.protobuf.Timestamp({
...
/* harmony import */ var _apollo_protobufjs_minimal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(65189);
