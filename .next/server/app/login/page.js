...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 90172)), "D:\\projects\\ayurarogyam-web\\app\\login\\page.tsx"],
    ...
    const pages = ["D:\\projects\\ayurarogyam-web\\app\\login\\page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 5318))
    ...
    async function logIn(e) {
        ...
        try {
            ...
            if (res.error) {
                ...
                react_toastify__WEBPACK_IMPORTED_MODULE_4__.toast.success("Success Notification!", {
...
;// CONCATENATED MODULE: ./app/login/LoginForm.tsx

const proxy = (0,module_proxy.createProxy)(String.raw`D:\projects\ayurarogyam-web\app\login\LoginForm.tsx`)
...
function page(params) {
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx("section", {
        className: "bg-gray-50 dark:bg-gray-900 my-0 py-0 ",
        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
            className: "flex flex-col items-center justify-between   h-screen  mx-auto  lg:py-0",
            children: [
                /*#__PURE__*/ jsx_runtime_.jsx("div", {
                    className: "flex flex-col items-center justify-center w-full  h-full",
                    children: /*#__PURE__*/ jsx_runtime_.jsx("div", {
                        className: "w-full bg-white rounded-lg shadow dark:border  sm:max-w-md xl:py-0 dark:bg-gray-800 dark:border-gray-700 ",
                        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                            className: "px-6 space-x-4 md:space-x-6 ",
                            children: [
                                ...
                                /*#__PURE__*/ jsx_runtime_.jsx("h1", {
                                    className: "text-xl font-bold leading-tight mb-4 tracking-tight place-self-center text-primary-700 md:text-2xl dark:text-white",
...
var __webpack_exports__ = __webpack_require__.X(0, [3763,4444,6750,3370,3578,1299,6418,4748], () => (__webpack_exec__(76140)));
