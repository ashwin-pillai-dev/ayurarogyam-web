...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 8095)), "D:\\projects\\ayurarogyam-web\\app\\admin\\inventory\\add\\page.tsx"],
...
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 63229)), "D:\\projects\\ayurarogyam-web\\app\\admin\\loading.js"],
    ...
    const pages = ["D:\\projects\\ayurarogyam-web\\app\\admin\\inventory\\add\\page.tsx"];
    
    const originalPathname = "/admin/inventory/add/page"
    const __next_app__ = {
...
module.exports = {
  '6ec40b2958eb4850e00a414d237c7022a9a2d82a': endpoint.bind(null, '6ec40b2958eb4850e00a414d237c7022a9a2d82a'),
}
            ...
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(flowbite_react__WEBPACK_IMPORTED_MODULE_1__.Select, {
                        ...
                        required: true,
                        children: inventoryTypes.map((inventoryType)=>{
                            return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("option", {
                                value: inventoryType.id,
                                children: inventoryType.name
                            }, inventoryType.id);
                        })
                    })
                ]
...
__webpack_require__.d(__webpack_exports__, {
  addInventory: () => (/* binding */ addInventory)
});
...
;// CONCATENATED MODULE: ./app/admin/inventory/actions.ts
/* __next_internal_action_entry_do_not_use__ addInventory */ 
...
async function addInventory(input) {
    ...
    console.log(data);
    try {
        const inventory = await prisma/* default */.Z.inventory.create({
            data
        });
        (0,cache.revalidatePath)(`/admin/inventory/list`);
        (0,navigation.redirect)(`/admin/inventory/list`);
    } catch (error) {
...
(0,action_proxy/* default */.Z)("6ec40b2958eb4850e00a414d237c7022a9a2d82a", null, addInventory);
...
const proxy = (0,module_proxy.createProxy)(String.raw`D:\projects\ayurarogyam-web\app\admin\inventory\add\formItems.tsx`)
...
// EXTERNAL MODULE: ./app/admin/inventory-type/services.ts
var inventory_type_services = __webpack_require__(75927);
;// CONCATENATED MODULE: ./app/admin/inventory/add/page.tsx
...
async function page() {
    const productData = (0,services/* getProducts */.X)();
    const inventoryTypeData = (0,inventory_type_services/* getInventoryTypes */.W)();
    const [products, inventoryTypes] = await Promise.all([
        productData,
        inventoryTypeData
    ]);
...
var __webpack_exports__ = __webpack_require__.X(0, [3763,3851,4444,6750,8421,1476,9060,3370,7114,6133,188,3578,4378,8875,369,5291,3353,9540,9733,5918], () => (__webpack_exec__(52981)));
