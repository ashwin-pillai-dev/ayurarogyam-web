...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 73665)), "D:\\projects\\ayurarogyam-web\\app\\admin\\prices\\list\\[product]\\page.tsx"],
...
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 63229)), "D:\\projects\\ayurarogyam-web\\app\\admin\\loading.js"],
    ...
    const pages = ["D:\\projects\\ayurarogyam-web\\app\\admin\\prices\\list\\[product]\\page.tsx"];
    
    const originalPathname = "/admin/prices/list/[product]/page"
    const __next_app__ = {
...
;// CONCATENATED MODULE: ./app/admin/prices/services.ts
async function getPrices(productId) {
    try {
        const response = await fetch(`http://localhost:3000/api/prices?productId=${productId}`, {
            cache: "no-store"
        });
        if (response.ok) {
...
;// CONCATENATED MODULE: ./app/admin/prices/list/[product]/page.tsx
                            ...
                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("a", {
                                        href: `/admin/prices/add/${productId}`,
                                            ...
                                            children: [
                                                /*#__PURE__*/ jsx_runtime_.jsx("th", {
                                                    ...
                                                    children: /*#__PURE__*/ jsx_runtime_.jsx("span", {
                                                        ...
                                                        children: price.clientType.name
                                                    })
                                                }),
                                                /*#__PURE__*/ jsx_runtime_.jsx("td", {
                                                    className: "px-4 py-3",
                                                    children: price.startingQtyLimit
                                                }),
                                                /*#__PURE__*/ jsx_runtime_.jsx("td", {
                                                    className: "px-4 py-3",
                                                    children: price.endingQtyLimit
                                                }),
                                                /*#__PURE__*/ jsx_runtime_.jsx("td", {
                                                    className: "px-4 py-3",
...
var __webpack_exports__ = __webpack_require__.X(0, [3763,3851,4444,6750,8421,1476,9060,3370,7114,6418,9733,5918], () => (__webpack_exec__(43235)));
