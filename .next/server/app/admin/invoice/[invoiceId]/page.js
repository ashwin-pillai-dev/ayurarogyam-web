...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 67045)), "D:\\projects\\ayurarogyam-web\\app\\admin\\invoice\\[invoiceId]\\page.tsx"],
...
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 63229)), "D:\\projects\\ayurarogyam-web\\app\\admin\\loading.js"],
    ...
    const pages = ["D:\\projects\\ayurarogyam-web\\app\\admin\\invoice\\[invoiceId]\\page.tsx"];
    
    const originalPathname = "/admin/invoice/[invoiceId]/page"
    const __next_app__ = {
...
;// CONCATENATED MODULE: ./app/admin/invoice/services.ts
async function getInvoiceById(invoiceId) {
    try {
        const response = await fetch(`http://localhost:3000/api/invoice?invoiceId=${invoiceId}`, {
            cache: "no-store"
        });
        if (response.ok) {
...
;// CONCATENATED MODULE: ./app/admin/invoice/[invoiceId]/page.tsx
                ...
                children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("table", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ jsx_runtime_.jsx("tbody", {
                            children: invoiceItems.map((item)=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)("tr", {
                                    children: [
...
var __webpack_exports__ = __webpack_require__.X(0, [3763,3851,4444,6750,8421,1476,9060,3370,7114,6418,9733,5918], () => (__webpack_exec__(99512)));
