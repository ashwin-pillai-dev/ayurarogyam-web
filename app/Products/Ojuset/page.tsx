        ...
        <div>
            ...
            <div className="container mx-auto">
                <section className="dark:bg-gray-900">
                    <div className="md:grid md:grid-cols-2 justify-between   pt-5">
                        {/* Product 1 */}
                        <div className="md:order-1  p-4">
                            <h2 className="text-xl font-medium mb-4 text-gray-600">OJUSET CAPSULE</h2>
                            <h1 className="text-4xl font-bold mb-4 font-serif text-primary-700">Unlock Your Bodybuilding Potential with Ojuset Capsule</h1>

                            <p className="text-gray-500 mb-6">
                                Ojuset Capsule contains ingredients like Shilajith, Ashwagandha, Musli, Kapi Kachu, Gokshura, and Kokilaksha that have various benefits
                                for individuals who engage in regular exercise and workouts.
                            ...
                            <h2 className="mb-4 text-4xl tracking-tight font-bold text-primary-700 dark:text-white">Muscle Strength and Recovery</h2>


                            <p className="text-gray-500 sm:text-xl dark:text-gray-400">
                                Ojuset Capsule's blend of natural ingredients can help strengthen bone and muscle tissue, aiding in the
                                development of lean muscle mass.It may assist in reducing exercise-related muscle pain and soreness,
                                promoting faster recovery between workouts.

                            </p>
                        </div>

                        <div className="md:order-2 justify-self-center">
                            <Image
                                src="/ojuset-gym.avif"
                                alt="Kurol Tablet"
                                width={400}
